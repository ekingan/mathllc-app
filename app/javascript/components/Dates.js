  ...
  render () {
    return (
      <div className="home-container">
        ...
        <Nav />
        <TextBox text={"IMPORTANT 2022 TAX DEADLINES:"} />
        <div className="dates">
          <Item text={"Jan 18th, 2022"} />
          <SubItem text={"Fourth quarter estimated tax payments due for tax year 2021."} />

          <Item text={"Jan 31st, 2022"} />
          <SubItem text={"Forms 1099-misc/nec must be sent to independent contractors, w-2s must be sent to employees, and information returns 1096, 1099 and w-2 must be sent to the IRS."} />

          <Item text={"Feb 20th, 2022"} />
          <SubItem text={"Last day to provide Math LLC with your paperwork in order to meet March 15th deadlines."} />

          <Item text={"March 15th, 2022"} />
          ...
          <Item text={"March 20th, 2022"} />
          <SubItem text={"Last day to provide Math LLC with your tax paperwork in order to meet the April 18th filing deadline."} />

          <Item text={"April 18th, 2022"} />
          ...
          <Item text={"November 15th, 2022"} />
          <SubItem text={"Extended non-profit tax returns due."} />

          <Item text={"Estimated tax due dates for 2022: Q1 April 18th, Q2 June 15th, Q3 Sept 15th, and Q4 Jan 15th, (2023)"} />
